...
execute store result score @s jw_aa_calc run data get entity @s ArmorItems[3].tag.jw_aa.keyframes
...
data modify entity @s ArmorItems[3].tag.jw_aa.Pos set from entity @s Pos
