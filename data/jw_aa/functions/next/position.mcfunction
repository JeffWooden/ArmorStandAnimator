...
execute store result storage jw:aa temp.Pos[0] double 0.01 run scoreboard players operation x jw_aa_calc += a jw_aa_calc
execute store result storage jw:aa temp.Pos[1] double 0.01 run scoreboard players operation y jw_aa_calc += b jw_aa_calc
execute store result storage jw:aa temp.Pos[2] double 0.01 run scoreboard players operation z jw_aa_calc += c jw_aa_calc